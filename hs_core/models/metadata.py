...
# I can find no record of languages_iso existing
#from languages_iso import languages as iso_languages
iso_languages = [('en', 'English'), ('af', 'Afrikaans')]
...
class CoreMetaData(models.Model):
    from resource import GenericResource # Direct import within models module only
